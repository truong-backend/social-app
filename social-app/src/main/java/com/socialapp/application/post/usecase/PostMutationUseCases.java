...
class UpdatePostContentUseCase {
    ...
    public PostResponse execute(String requesterId, String postId,
                                UpdatePostContentRequest request,
    ...
    private PostResponse toResponse(Post post) {
        return new PostResponse(post.getId(), post.getAuthorId(), null, null,
...
class DeletePostUseCase {
    ...
    @Transactional
    public MessageResponse execute(String requesterId, String postId, boolean isAdmin) {
