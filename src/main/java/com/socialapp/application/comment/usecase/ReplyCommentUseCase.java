...
public class ReplyCommentUseCase {
    ...
    public ReplyCommentUseCase(CommentRepository commentRepository, PostRepository postRepository,
                               CommentDomainService commentDomainService, FileStorage fileStorage,
