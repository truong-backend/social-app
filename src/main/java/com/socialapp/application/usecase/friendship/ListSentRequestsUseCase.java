...
public class ListSentRequestsUseCase {
    private final UserRepository userRepository;
    private final UserMapper userMapper;

    public ListSentRequestsUseCase(UserRepository userRepository, UserMapper userMapper) {
    ...
    public PageResponse<UserResponse> execute(String userId, PageRequest page) {
        ...
        List<UserResponse> items = userRepository
                .listSentRequests(new UserId(userId), limit, offset)
